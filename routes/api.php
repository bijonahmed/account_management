...
Route::middleware('auth:sanctum')->group(function () {
  ...
  Route::group(['prefix' => 'company'], function () {
    Route::get('/getCategoryList', [App\Http\Controllers\API\BankController::class, 'getCategoryList']);
    Route::post('/companyWiseCategoryInsert', [App\Http\Controllers\API\BankController::class, 'companyWiseCategoryInsert']);
    Route::post('/companyInsert', [App\Http\Controllers\API\BankController::class, 'bankCompany']);
    Route::get('/getcountryList', [App\Http\Controllers\API\BankController::class, 'getcountryList']);
    Route::get('/getcompanyrow', [App\Http\Controllers\API\BankController::class, 'editCompany']);
