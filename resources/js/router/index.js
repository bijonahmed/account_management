...
//Company
const companyCategoryList = () => import("../pages/companyCategoryList.vue");
const myCoompanyList = () => import("../pages/CompanyList.vue");
    ...
    },
    {
        ...
        meta: { requiresAuth: true },
...

            {
                path: "/mycompany-list",
                name: "mycompany-list",
                component: myCoompanyList,
                meta: { requiresAuth: true },
            },

 {
                path: "/company-wise-category-list",
                name: "company-wise-category-list",
