            ...
            <div class="page-content">
                ...
                <div class="alert-primary" role="alert">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <router-link to="/supplier/supplier-list"><span
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form @submit.prevent="saveData()" id="formrest" class="forms-sample"
                                    ...
                                    <div class="row mb-3">
                                        <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Supplier
                                            Name</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control type" v-model="cdata.type" id="type"
                                                placeholder="">
                                        </div>
                                    </div>
