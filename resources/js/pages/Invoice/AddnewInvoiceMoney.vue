            ...
            <div class="page-content">
                <div class="alert-primary" role="alert">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <router-link to="/invoice/invoice-list-money-transfer"><span
                                ...
                                <form @submit.prevent="addItem()" id="formrest" class="forms-sample"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="row mb-1">
                                                <label for="exampleInputUsername2"
                                                    class="col-sm-4 col-form-label">Transaction Ref.</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control transaction_ref"
                                                        v-model="insertData.transaction_ref" id="transaction_ref"
                                                        autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="row mb-1">
                                            ...
                                            <div class="row mb-1">
                                                <label for="exampleInputUsername2" class="col-sm-4 col-form-label">Bene.
                                                    City</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control beneficiary_city"
                                                        v-model="insertData.beneficiary_city" id="beneficiary_city"
                                                        autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="row mb-1">
                                                <label for="exampleInputUsername2" class="col-sm-4 col-form-label">Bene.
                                                    Country</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control beneficiary_country"
                                                        v-model="insertData.beneficiary_country"
                                                        id="beneficiary_country" autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="row mb-1">
                                                <label for="exampleInputUsername2" class="col-sm-4 col-form-label">Bene.
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control beneficary_contact_num"
                                                        v-model="insertData.beneficary_contact_num"
                                                        id="beneficary_contact_num" placeholder="XXXXXX"
                                                        autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="row mb-1">
                                                <label for="exampleInputUsername2"
                                                    class="col-sm-4 col-form-label">Payment Receive</label>
                                                <div class="col-sm-8">
                                                    <select name="payment_receive" v-model="insertData.payment_receive"
                                                        class="form-select payment_receive">
                                            ...
                                            <div class="row mb-1">
                                                <label for="exampleInputUsername2"
                                                    class="col-sm-4 col-form-label">Payment Type</label>
                                                <div class="col-sm-8">
                                                    <select name="payment_type" v-model="insertData.payment_type"
                                                        class="form-select payment_type" @change="payType">
                                            ...
                                            <div v-if="insertData.p_type == 1">
                                                ...
                                                <div class="row mb-1">
                                                    <label for="exampleInputUsername2"
                                                        class="col-sm-4 col-form-label">Bkash Number</label>
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control bkash_number"
                                                            v-model="insertData.bkash_number" id="bkash_number">
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row mb-1">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control bank_name"
                                                                v-model="insertData.bank_name" id="bank_name">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-1">
                                                        <label for="exampleInputUsername2"
                                                            class="col-sm-4 col-form-label">Bank Branch</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control branch_name"
                                                                v-model="insertData.branch_name" id="branch_name">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-1 level_bkash_num">
                                                        <label for="exampleInputUsername2"
                                                            class="col-sm-4 col-form-label">Account No</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control acc_no"
                                                                v-model="insertData.acc_no" id="acc_no">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div v-if="insertData.p_type == 3">
                                                ...
                                                <div class="row mb-1">
                                                    <label for="exampleInputUsername2"
                                                        class="col-sm-4 col-form-label">Pickup Bank Name</label>
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control bank_name"
                                                            v-model="insertData.bank_name" id="bank_name">
                                                    </div>
                                                ...
                                                <div class="row mb-1">
                                                    <label for="exampleInputUsername2"
                                                        class="col-sm-4 col-form-label">Pickup Bank Branch</label>
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control branch_name"
                                                            v-model="insertData.branch_name" id="branch_name">
                                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="row mb-1">
                                                <label for="exampleInputUsername2"
                                                    class="col-sm-5 col-form-label">Rate</label>
                                                <div class="col-sm-7">
                                                    <input type="text" autocomplete="off"
                                                        class="form-control rate onlyNumbersInput"
                                                        v-model="insertData.rate" id="rate" placeholder="0.00">
                                                </div>
                                            </div>
                                            <div class="row mb-1">
                                                <label for="exampleInputUsername2"
                                                    class="col-sm-5 col-form-label">Fees</label>
                                                <div class="col-sm-7">
                                                    <input type="text" autocomplete="off"
                                                        class="form-control fees onlyNumbersInput"
                                                        v-model="insertData.fees" id="fees" placeholder="0.00">
                                                </div>
                                            </div>

                                            <div class="row mb-1">
                                                <label for="exampleInputUsername2"
                                                    class="col-sm-5 col-form-label">Others Fees</label>
                                                <div class="col-sm-7">
                                                    <input type="text" autocomplete="off"
                                                        class="form-control others_fees onlyNumbersInput"
                                                        v-model="insertData.others_fees" id="others_fees"
                                                        placeholder="0.00">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-1">
                                                <label for="exampleInputUsername2"
                                                    class="col-sm-5 col-form-label">Receiving BD Amount</label>
                                                <div class="col-sm-7">
                                                    <input type="text" autocomplete="off"
                                                        class="form-control receiving_amount onlyNumbersInput"
                                                        v-model="insertData.receiving_amount" id="receiving_amount"
                                                        placeholder="0.00" @keyup="calculated">
                                                </div>
                                            </div>
                                            <div class="row mb-1">
                                                <label for="exampleInputUsername2"
                                                    class="col-sm-5 col-form-label">Customer Amount</label>
                                                <div class="col-sm-7">
                                                    <input type="text" autocomplete="off"
                                            ...
                                            <div class="row mb-1">
                                                <label for="exampleInputUsername2" class="col-sm-5 col-form-label">Net
                                                    Amount</label>
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control net_amount onlyNumbersInput"
                                                        v-model="insertData.net_amount" id="net_amount"
                                            ...
                                            <div class="row mb-1">
                                                <label for="exampleInputUsername2"
                                                    class="col-sm-5 col-form-label">Profit</label>
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control profit onlyNumbersInput"
                                                        v-model="insertData.profit" id="profit" placeholder="0.00"
                                                        autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="row mb-1">
                                                <label for="exampleInputUsername2"
                                                    class="col-sm-5 col-form-label">Customer Deposit</label>
                                                <div class="col-sm-7">
                                                    <input type="text"
                                                        class="form-control customer_deposit onlyNumbersInput"
                                                        v-model="insertData.customer_deposit" id="customer_deposit"
                                                        autocomplete="off" placeholder="0.00" @keyup=getDueAmt()>
                                                </div>
                                            </div>
                                            <div class="row mb-1">
                                                <label for="exampleInputUsername2" class="col-sm-5 col-form-label">Due
                                                    Amount</label>
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control due_amount onlyNumbersInput"
                                                        v-model="insertData.due_amount" id="due_amount"
...
export default {
    ...
    methods: {
        ...
        profitCalculate() {
            ...
            //insertData.net_amount
            this.getnetAmount();
        },
        getnetAmount() {
            const profit = this.insertData.profit;

            const totalAmount = parseFloat(this.insertData.total_amount) || 0;
            const resultValue = parseFloat(profit) || 0;

            const netAmount = totalAmount - resultValue;
            this.insertData.net_amount = parseFloat(netAmount.toFixed(2));
