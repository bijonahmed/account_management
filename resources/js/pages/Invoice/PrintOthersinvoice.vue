            ...
            <div id="printableArea">
                <div class="page-content" style="background-color: white;">
                            ...
                            <td colspan="2" rowspan="2">
                                <table width="100%" border="0" align="left">
                                    <tr>
                                        ...
                                        <td width="19%"><span class="style4">:{{ customerInfo.others_inv_id }}</span>
                                        </td>
                                        <td width="22%">&nbsp;</td>
                                    ...
                                    <tr>
                                        <td><span class="style4">Supplier</span></td>
                                        <td><span class="style4">:{{ customerInfo.suplierName }}</span></td>
                                        <td>&nbsp;</td>
                                        <td><span class="style4"></span></td>
                                        <td><span class="style4"></span></td>
                                    </tr>
                                    <tr>
                                        <td><span class="style4">Beneficiary</span></td>
                                        <td><span class="style4">:{{ customerInfo.beneficiary_name }}</span></td>
                                        <td>&nbsp;</td>
                                        <td><span class="style4"></span></td>
                                        <td><span class="style4"></span></td>
                                    </tr>
                        ...
                        <tr>
                            <td><strong>{{ cdata.company_name }}</strong><br />
                                <span class="style1">{{ cdata.address }}<br />
                                    {{ cdata.tel }}</span><br />
                                <span class="style1">Email: {{ cdata.email }}</span>
                            </td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                    ...
                    <table width="100%" border="1">
                        ...
                        <tr>
                            <td colspan="2" rowspan="2"><span class="style9">Invoice</span><span class="style9">:
                                    No: {{ customerInfo.invoice_no }}</span>
                            </td>
                            <td><span class="style9">Amount</span></td>
                            <td><span class="style9">:{{ customerInfo.amount }}</span></td>
                        </tr>
                        ...
                        <tr>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                            <td><span class="style9">Total Amount</span></td>
                            <td><span class="style9">:{{ customerInfo.total_amount }}</span></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                        ...
                        <tr>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                            <td><span class="style9">Charge/Fee</span></td>
                            <td><span class="style9">:{{ customerInfo.charge_fee }}</span></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                            <td><span class="style9">Amount Remaining</span></td>
                            <td><span class="style9">:{{ customerInfo.amount_remaining }}</span></td>
                        </tr>
                    </table>
...
export default {
    ...
    methods: {
        findInvoiceId() {
            this.axios
                .get(`/api/category/geteditInvoiceOthersData/${this.$route.params.id}`)
                .then((response) => {
                    //Invoice
                    this.customerInfo.invoice_no = response.data.data.invoice_no;
                    ...
                    this.customerInfo.suplierName = response.data.suplierName;
                    ...
                    this.customerInfo.amount = response.data.data.amount;
                    ...
                    this.customerInfo.charge_fee = response.data.data.charge_fee;
                    this.customerInfo.amount_remaining = response.data.data.amount_remaining;
