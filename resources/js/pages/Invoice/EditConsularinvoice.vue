        ...
        <div class="page-content">
            <div class="alert-primary" role="alert">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <router-link to="/invoice/invoice-list-consular"><span stye="text-align:center;">Back</span></router-link>
                    </div>
                </div>
            </div><br>
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form @submit.prevent="addItem()" id="formrest" class="forms-sample" enctype="multipart/form-data">
                                <div class="row">
                                    <input type="hidden" class="form-control consular_inv_id" v-model="insertData.consular_inv_id" id="consular_inv_id" autocomplete="off">
