                                ...
                                <form @submit.prevent="addItem()" id="formrest" class="forms-sample"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="row mb-1">
                                                <label for="exampleInputUsername2"
                                                    class="col-sm-4 col-form-label">Purpose</label>
                                                <div class="col-sm-8">
                                                    <select name="purpose" v-model="insertData.purpose"
                                                        class="form-select purpose">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="row mb-1">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" autocomplete="off"
                                                        class="form-control customer_amount onlyNumbersInput"
                                                        v-model="insertData.customer_amount" id="customer_amount"
                                                        placeholder="0.00">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-1">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control net_amount onlyNumbersInput"
                                                        ...
                                                        autocomplete="off" placeholder="0.00" @keyup="getProfit">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-1">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control amount_paid onlyNumbersInput"
                                                        ...
                                                        autocomplete="off" placeholder="0.00" @keyup=dueAmount>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-1">
                                                <label for="exampleInputUsername2"
                                                    class="col-sm-5 col-form-label">Due</label>
                                                <div class="col-sm-7">
...
export default {
    ...
    methods: {
        ...
        findRowId() {
            this.axios
                .get(`/api/user/getCompanySettingForConsular`)
                .then((response) => {
        ...
        addItem() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    axios.post('/api/category/saveInvoiceConsular',
                        formData, {
                        headers
                    }).then((res) => {
                        $('#formrest')[0].reset();
